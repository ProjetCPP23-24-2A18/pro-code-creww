...
smtpt::smtpt( const QString &user, const QString &pass, const QString &host, int port, int timeout )
...
void smtpt::sendMail(const QString &from, const QString &to, const QString &subject, const QString &body, QStringList files)
...
void smtpt::stateChanged(QAbstractSocket::SocketState socketState)
...
void smtpt::errorReceived(QAbstractSocket::SocketError socketError)
